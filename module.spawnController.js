...
// Spawning settings
var AUTOSPAWN_AT_ENERGY = Math.ceil( Game.spawns.Spawn1.room.energyCapacityAvailable * .66, 700 );
...
var maximumNumberOfUpgraders = 5;
var minimumNumberOfBuilders = 1;
var maximumNumberOfBuilders = 1;
var minimumNumberOfRepairers = 1;
var maximumNumberOfRepairers = 1;
var minimumNumberOfWallRepairers = 1;
var maximumNumberOfWallRepairers = 1;
...
module.exports = function(  ) {
   ...
   /* -------- Spawn Module -------- */
    ...
    if ( Game.spawns.Spawn1.canCreateCreep( [WORK, WORK, WORK, WORK, WORK, WORK, WORK] ) == OK ) {
        //console.log('Insidess spawnController main loop; energy=' + energy);
        ...
        if (numberOfMiners < minimumNumberOfMiners) {  name = Game.spawns.Spawn1.createCustomCreep(energy, 'fullTimeMiner'); role = 'miner'; }
            ...
            //Overriding ratio selector for a test
            sourceId = sourceIdList[0];
